    ...
    <section className="max-w-5xl mx-auto px-6 pt-24 pb-12 bg-white">
      <div className="text-center mb-10">
        ...
        <p className="text-justify text-gray-700 leading-relaxed mb-4">
          ...
          clientele, which includes private individuals, multinational
          corporations, banks, and leading commercial establishments—both
          domestic and international—who continue to place their trust in us
          time and again.
        </p>
      </div>
      ...
      <div className="max-w-5xl mx-auto border border-gray-300">
        <div className="grid grid-cols-2 md:grid-cols-4">
          {corporateClients.map((client) => (
            <div
              key={client.id}
              className="flex flex-col items-center justify-center h-40 w-full p-4 lg:px-8 bg-white hover:bg-gray-50 transition border border-gray-300"
            >
              <img
                src={client.logo}
                alt={client.name}
